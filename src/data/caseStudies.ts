...
export const caseStudies: CaseStudy[] = [
  {
    ...
    credits: [
      ...
      { role: "Sound design, mix & master", name: "Auden" },
      { role: "Client", name: "Bandit Grand Prix" },
    ],
    content: {
      en: {
        ...
        craft: [
          ...
          },
          {
            ...
            body: "Inside the loop, the electronic base locks to the BPM of breath and stride. Steps, breath and pulse work as a single rhythmic organism, so the piece feels organic, even though the music is synthetic.",
          },
          {
        ...
        deliverableItems: "Original electronic score & production · Sound design · Mix & master",
      ...
      es: {
        ...
        craft: [
          ...
          },
          {
            ...
            body: "Una vez dentro del loop, la base electronica se ancla al BPM de la respiracion y la zancada. Pasos, aliento y pulso musical funcionan como un mismo organismo ritmico, asi la pieza se siente organica aunque la musica sea sintetica.",
          },
          {
        ...
        deliverableItems: "Banda sonora electronica original · Diseno sonoro · Mezcla y master",
